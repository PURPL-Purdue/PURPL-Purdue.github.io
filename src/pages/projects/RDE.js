...
const sharedAboutPhotos = [
    { src: "/images/team/group_photos/2025_fall/IMG_8459_cropped.jpg", alt: "PURPL fall 2025 team photo" },
    { src: "/images/projects/rde/2025-media/DazzleShotImages_011.jpg", alt: "RDE team project meeting" },
    { src: "/images/team/group_photos/2025_fall/IMG_8462_cropped.jpg", alt: "PURPL fall 2025 team group photo" },
    { src: "/images/projects/rde/2025-media/IMG_7460.jpg", alt: "RDE student presenting hardware" },
    { src: "/images/projects/rde/2025-media/DazzleShotImages_006.jpg", alt: "RDE team working during a project meeting" },
];

const sharedAIAAPhotos = [
    { src: "/images/projects/rde/2026-aiaa/IMG_0321.jpg", alt: "PURPL presenting RDE research at AIAA Region III" },
    { src: "/images/projects/rde/2026-aiaa/IMG_0521.jpg", alt: "PURPL RDE presentation at AIAA Region III" },
    { src: "/images/projects/rde/2026-aiaa/IMG_0485.jpg", alt: "PURPL poster discussion at AIAA Region III" },
    { src: "/images/projects/rde/2026-aiaa/8DFCB7A6-FEF2-422E-AE39-C8209BDE6634.jpg", alt: "PURPL team at AIAA Region III" },
    { src: "/images/projects/rde/2026-aiaa/IMG_7202.jpg", alt: "PURPL RDE project display at AIAA Region III" },
];
...
const sharedRoadmap = [
    ...
    ["Oct 2025", "Renamed to HADES", "RDC project renamed to HADES."],
    ["Apr 2025", "Conceptual Design Review Complete", "Initial concept and direction reviewed."],
    ["Jan 2025", "Project Founded", "RDE project begins as LOKI."],
];
...
const hadesData = {
    ...
    selector_blurb: "HADES (Hydrogen-Air Detonation Engine by Students) is PURPL’s hydrogen-air rotating detonation combustor, developed to advance air-breathing detonation technology for sustainable power generation applications.",
    dashboard_title: "Current HADES Status",
    dashboard_blurb: "HADES is currently in the manufacturing phase following a successful Critical Design Review and a third-place finish at the 2026 AIAA Region III Student Conference. The team is preparing for Fall 2026 hotfire testing and future turbine integration.",
    dashboard_cards: [
    ...
    featured: {
        photos: [
            { src: "/images/projects/rde/shared/featured-render.png", alt: "HADES combustor render" },
            { src: "/images/projects/rde/shared/engine-render-1.png", alt: "HADES combustor render" },
            { src: "/images/projects/rde/shared/engine-cross-section.png", alt: "HADES combustor cross section" },
        ],
        blurb: "The Hydrogen-Air Detonation Engine by Students (HADES) is a hydrogen-air rotating detonation combustor designed for future integration with gas turbines for sustainable power generation applications.",
    },
    about: {
        title: "About HADES",
        blurb: "HADES gives undergraduate students hands-on experience in the design, analysis, manufacturing, and experimental validation of hydrogen-air rotating detonation combustors for sustainable power generation. The team has made rapid progress through design review, AIAA presentation, and current manufacturing preparation.",
        photos: [
            { src: "/images/projects/rde/hades/presentation-1.png", alt: "HADES presentation photo" },
            { src: "/images/projects/rde/hades/presentation-2.png", alt: "HADES poster discussion" }
        ],
    },
...
const deimosData = {
    ...
    selector_blurb: "DEIMOS is PURPL’s methane-gaseous oxygen rotating detonation rocket engine, expanding the team’s research into liquid rocket propulsion and high-performance rotating detonation engines.",
    dashboard_title: "Current DEIMOS Status",
    dashboard_blurb: "DEIMOS is PURPL’s second rotating detonation engine program. The project focuses on methane-gaseous oxygen propulsion and is currently progressing through hardware manufacturing ahead of hotfire testing.",
    dashboard_cards: [
        ["STATUS", "Manufacturing"],
    ...
    featured: {
        photos: [
            { src: "/images/projects/rde/shared/status-photo-1.png", alt: "DEIMOS rotating detonation rocket engine poster" }
        ],
        blurb: "DEIMOS is a methane-gaseous oxygen rotating detonation rocket engine designed to investigate compact, high-performance rocket propulsion using rotating detonation combustion.",
    },
    about: {
        title: "About DEIMOS",
        blurb: "DEIMOS is PURPL’s methane-gaseous oxygen rotating detonation rocket engine, developed to investigate high-performance rocket propulsion through rotating detonation combustion. The project builds on PURPL’s experience with HADES while expanding into liquid rocket engine research.",
        photos: [
            { src: "/images/projects/rde/deimos/presentation-1.png", alt: "DEIMOS presentation photo" }
        ],
    },
    highlight: "Hardware manufacturing is underway, with full engine assembly targeted ahead of Fall 2026 hotfire testing. Research results will be presented at AIAA SciTech 2027.",
    specs_table: {
        "thrust": "1350 N",
            ...
            <ContentWrapper>
                <div className="lg:w-[800px] flex flex-col space-y-8 md:space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <EngineSelector engine={hadesData} activeEngine={activeEngine} setActiveEngine={setActiveEngine} />
                        <EngineSelector engine={deimosData} activeEngine={activeEngine} setActiveEngine={setActiveEngine} />
                    </div>
                    ...
                    <RoadmapPreview roadmap={sharedRoadmap} />
                </div>
            </ContentWrapper>
        </PageWrapper>
    );
