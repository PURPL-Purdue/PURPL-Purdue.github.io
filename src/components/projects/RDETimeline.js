    ...
    <div className="w-full flex flex-col items-center h-fit">
      <div className="w-full overflow-x-scroll h-fit">
        <div className="relative w-max flex flex-row items-center justify-center">
          ...
          <div className="absolute top-[34%] md:top-[35%] lg:top-[25%] left-0 min-w-full h-0.5 bg-stardust"></div>
          {timelineData.map((item, idx) => (
            <div key={idx} className="relative flex flex-col items-center mx-4">
              {/* Timeline dot centered on the line */}
              <div className="absolute left-1/2 top-[34%] md:top-[35%] lg:top-[25%]" style={{transform: 'translate(-50%, -50%)'}}>
              ...
              <div className="text-center">
                ...
                <p className="font-display2 text-sm md:text-md lg:text-lg text-white max-w-xs max-w-[75px] md:max-w-[110px] md:h-[1px] lg:h-[150px] lg:max-w-[180px] mt-6 md:mt-8 lg:mt-12">{item.description}</p>
              </div>
            </div>
          ))}
        </div>
