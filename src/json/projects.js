...
export const ttpData = {
    ...
    about_team: {
        photos: [
            {
                src: teamPhotos.ttp.smiling_photo,
                alt: "Torch training program team members smiling",
            },
            {
                src: teamPhotos.ttp.fun_photo,
                alt: "Torch training program team members having fun",
            },
        ]
    },
}
